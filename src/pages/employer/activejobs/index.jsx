                ...
                <div className="row">
                    <div className="col-xxl-2 col-xl-2 col-lg-12 col-md-12 col-sm-12 border-end d-flex flex-column  align-items-start p-3" style={{ minHeight: "100vh", overflow: "hidden" }}>
                        ...
                        <Link href='/employer/profile' className="btn w-100 text-start ps-3 mt-4"><IoSettings /><span className="ms-2">Profile</span> </Link>
                            ...
                            <Link href='/employer/activejobs' className="btn btn-primary w-100 text-start ps-3 mt-2"><MdOutlineSettingsApplications /> <span className="ms-2">Active jobs</span> </Link>
                            ...
                            <div className="col-xxl-8 col-xl-8 col-lg-12 col-md-12 col-sm-12 border-end">
                                ...
                                <div className="row mt-5">
                                    <div className="col-xxl-12 col-xl-12 col-ld-12 col-md-12  col-sm-12">
                                        <div className="card shadow-sm ms-3 me-3 mb-3 mt-0 d-flex  rounded-4 p-3" >
                                            ...
                                            <div className="row  mt-3 d-flex   align-items-center">
                                                <div className="col-10  d-flex justify-content-start align-items-center">
                                                    <Link href="/employer/appliedcandidates" className="btn btn-outline-primary "><GiPerson /><span className="ms-2">Applied candidates</span></Link>
                                                    <Link href="/employer/shortlistedcandidates" className="btn btn-outline-success ms-3"><GiPerson /><span className="ms-2">Shortlisted candidates</span></Link>


                                                </div>
                                                <div className="col-2  d-flex justify-content-end align-items-center">
                                                <span class="badge rounded-pill text-bg-success d-flex justify-content-center align-items-center" style={{width: "80px", height: "25px"}}>Active</span>
                                        ...
                                        <div className="card shadow-sm ms-3 me-3 mb-3 mt-0 d-flex  rounded-4 p-3" >
                                            ...
                                            <div className="row  mt-3 d-flex   align-items-center">
                                                <div className="col-10  d-flex justify-content-start align-items-center">
                                                    ...
                                                    <Link href="/employer/appliedcandidates" className="btn btn-outline-success ms-3"><GiPerson /><span className="ms-2">Shortlisted candidates</span></Link>
                                        ...
                                        <div className="card shadow-sm mb-5 ms-3 me-3 mb-3 mt-0 d-flex  rounded-4 p-3" >
                                            <div className="row ">
                                                <div className="mt-2  col-xxl-2  d-flex justify-content-center align-items-center col-xl-2 col-lg-12 col-sm-12 col-md-12">
                                                    <img
                                                        src='/vardhman.png'
